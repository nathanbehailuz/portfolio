...
const Contact = () => {
  const contactInfo = [
    ...
    },
    {
      icon: Github,
      label: 'GitHub',
      value: 'nathanbehailuz',
      href: 'https://github.com/nathanbehailuz'
    },
    {
      icon: Linkedin,
      label: 'LinkedIn',
      value: 'nathan-behailu',
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-gray-600 mt-4 max-w-2xl mx-auto">
            I'm always interested in new opportunities, collaborations, or just a friendly chat about technology and AI.
